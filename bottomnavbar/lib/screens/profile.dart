...
class _ProfileScreenState extends State<ProfileScreen> with SingleTickerProviderStateMixin {
  ...
  // Usuario de ejemplo para mostrar la interfaz
                    ...
                    children: [
                      Container(
                        ...
                        child: CircleAvatar(
                          ...
                          backgroundImage: demoUser.profilePicture != null
                              ? NetworkImage(demoUser.profilePicture!)
                              : null,
                          child: demoUser.profilePicture == null
                              ? Icon(Icons.person, size: 60, color: Color(0xFF4589FF))
                              : null,
                        ),
                      ),
                      Positioned(
                        ...
                        child: Container(
                          ...
                          child: IconButton(
                            icon: Icon(Icons.edit, color: Color(0xFF4589FF)),
